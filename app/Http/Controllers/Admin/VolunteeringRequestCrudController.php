 ...
 */
class VolunteeringRequestCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\VolunteeringRequest::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/volunteering-request');
        CRUD::setEntityNameStrings('طلب التطوع', 'طلبات التطوع');
    }
    ...
    {
        CRUD::setValidation(VolunteeringRequestRequest::class);
        ...
        CRUD::addField([
            'name' => 'status',
            'type' => 'enum',
            'enum_class' => VolunteeringRequestStatus::class,
    ...
    public function update()
    {
        ...
        $this->crud->getCurrentEntry()->user->notify(new \App\Notifications\ChangeStatusNotification($this->crud->getCurrentEntry(), 'volunteering_request'));
