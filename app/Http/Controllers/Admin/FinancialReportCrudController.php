...
/**
 * Class FinancialReportCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FinancialReportCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\FinancialReport::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/financial-report');
        CRUD::setEntityNameStrings('التقرير المالي', 'التقارير المالية');
    }
    ...
    {
        CRUD::setValidation(FinancialReportRequest::class);
        ...
        CRUD::field('file')
            ...
            ->withFiles([
                'disk' => 'digitalocean',
                'path' => 'financial-reports', // the path inside the disk where file will be stored
