...
use App\Http\Requests\EmploymentOpportunityRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class EmploymentOpportunityCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EmploymentOpportunityCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::setColumnDetails('job_title', [
            'label' => 'الوظيفة'
        ]);
        CRUD::setColumnDetails('job_desc', [
            'label' => 'تفاصيل الوظيفة'
        ]);
        CRUD::setColumnDetails('job_link', [
            'label' => 'رابط التسجيل'
        ]);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('job_title')->label('المسمى الوظيفي');
        CRUD::field('job_desc')->label('تفاصيل الوظيفة');
        CRUD::field('job_link')->label('رابط التقديم');
