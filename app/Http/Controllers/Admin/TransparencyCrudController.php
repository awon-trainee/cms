...
/**
 * Class TransparencyCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class TransparencyCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Transparency::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/transparency');
        CRUD::setEntityNameStrings('الإفصاح والشفافية', 'الإفصاح والشفافية');
    }
    ...
    {
        CRUD::setValidation(TransparencyRequest::class);
        ...
        CRUD::field('file')
            ...
            ->withFiles([
                'disk' => 'digitalocean',
                'path' => 'disclosure-and-transparency', // the path inside the disk where file will be stored
