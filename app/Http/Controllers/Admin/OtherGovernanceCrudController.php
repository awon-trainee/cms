...
/**
 * Class OtherGovernanceCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class OtherGovernanceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\OtherGovernance::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/other-governance');
        CRUD::setEntityNameStrings('حوكمة أخرى', 'حوكمة أخرى');
    }
    ...
    {
        CRUD::setValidation(OtherGovernanceRequest::class);
        ...
        CRUD::field('file')
            ...
            ->withFiles([
                'disk' => 'digitalocean',
                'path' => 'other-governance', // the path inside the disk where file will be stored
