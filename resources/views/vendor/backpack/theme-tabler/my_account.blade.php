            ...
            <div class="all">
                ...
                <div style="display: flex; justify-content: flex-end; align-items: center; gap: 20px;">
                    ...
                    <div style="display: flex; flex-direction: row; align-items: center; gap: 20px; margin-right: 20px;">
                        ...
                        <div style="text-align: right; margin-left: 130px;">
                            ...
                            <button id="update-button" style="background-color: #8c5ab4 !important; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; width: 220px;">تحديث البيانات الشخصية</button>
                        </div>
                    </div>
                    ...
                    <div class="design-section text-center mt-4" style="display: flex; justify-content: left;">
                        ...
                        <div class="card-container" style="border: 1px solid #ccc; border-radius: 10px; padding: 10px 20px; background-color: #FFFFFF; display: inline-block; float: left; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); width: 730px; height: 199px; margin-left: -50px;">
                            <!-- Container to hold all the cards side by side -->
                            <div style="display: flex; justify-content: space-between; gap: 25px;">
                                <!-- Card 1 -->
                                <div class="card first-card" style="text-align: center; border: 1px solid #ccc; padding: 10px; border-radius: 10px; background-color: #F3F4FB; width: 250px; height: 155px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: transform 0.3s; padding-top: 20px; margin-top: 10px;">
                                    <div style="display: flex; align-items: center; justify-content: center; height: 100%;">
                                        <!-- Image on the left -->
                                        <div style="margin-right: 10px; margin-bottom: 35px;">
                                            <img src="https://cdn-icons-png.flaticon.com/128/2988/2988036.png" alt="Idea Icon" style="width: 61px; height: 61px;">
                                        </div>
                                        <!-- Number on the right -->
                                        <b style="font-family: 'Tajwal', sans-serif; font-weight: bold;">
                                            <div style="font-size: 48px; color: #3542B8; margin-right: -15px; width: 78px; height: 104px;">3</div>
                                        </b>
                                    </div>
                                    <!-- Text below the number and image -->
                                    <div style="font-family: 'Tajwal', sans-serif; font-size: 1.3em; color: #5A5656; margin-top: -30px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; height: 34px;">عدد المبادرات المسجلة</div>
                                </div>

                                <!-- Card 2 -->
                                <div class="card" style="text-align: center; border: 1px solid #ccc; padding: 10px; border-radius: 10px; background-color: #F3F4FB; width: 250px; height: 155px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: transform 0.3s; padding-top: 20px; margin-top: 10px;">
                                    <div style="display: flex; align-items: center; justify-content: center; height: 100%;">
                                        <!-- Image on the left -->
                                        <div style="margin-right: 10px; margin-bottom: 35px;">
                                            <img src="https://cdn-icons-png.flaticon.com/128/1161/1161724.png" alt="Idea Icon" style="width: 61px; height: 61px;">
                                        </div>
                                        <!-- Number on the right -->
                                        <b style="font-family: 'Tajwal', sans-serif; font-weight: bold;">
                                            <div style="font-size: 48px; color: #3542B8; margin-right: -10px; width: 78px; height: 104px;">5</div>
                                        </b>
                                    </div>
                                    <!-- Text below the number and image -->
                                    <div style="font-family: 'Tajwal', sans-serif; font-size: 1.3em; color: #5A5656; margin-top: -30px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; height: 34px;">عدد رسائل التواصل</div>
                                </div>

                                <!-- Card 3 -->
                                <div class="card last-card" style="text-align: center; border: 1px solid #ccc; padding: 10px; border-radius: 10px; background-color: #F3F4FB; width: 250px; height: 155px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: transform 0.3s; padding-top: 20px; margin-top: 10px;">
                                    <div style="display: flex; align-items: center; justify-content: center; height: 100%;">
                                        <!-- Image on the left -->
                                        <div style="margin-right: 10px; margin-bottom: 25px;">
                                            <img src="https://cdn-icons-png.flaticon.com/128/1006/1006657.png" alt="Idea Icon" style="width: 61px; height: 61px;">
                                        </div>
                                        <!-- Number on the right -->
                                        <b style="font-family: 'Tajwal', sans-serif; font-weight: bold;">
                                            <div style="font-size: 48px; color: #3542B8; margin-right: -10px; width: 78px; height: 104px;">2</div>
                                        </b>
                                    </div>
                                    <!-- Text below the number and image -->
                                    <div style="font-family: 'Tajwal', sans-serif; font-size: 1.3em; color: #5A5656; margin-top: -30px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; height: 34px;">عدد طلبات الانضمام</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="button-content-section mt-5">
                    ...
                    <div class="content" id="about" style="display: block;">
                        ...
                        <div class="initiative-card" style="border: 1px solid #ccc; border-radius: 10px; padding: 20px; margin-bottom: 20px; background-color: #F3F4FB; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
        <h5 class="initiative-title" style="font-size: 1.5em; color: #2e4ca4; margin-bottom: 10px;">اسم المبادرة</h5>
        <div class="initiative-info" style="display: flex; justify-content: space-between; align-items: center;">
...
<style>
    ...
    .first-card {
        margin-left: 10px; /* تعديل الهامش على اليسار للبطاقة الأولى */
    }
    .last-card {
        margin-right: 10px; /* تعديل الهامش على اليمين للبطاقة الأخيرة */
    }
    .card-container {
        padding-left: 20px; /* زيادة الحافة اليسرى */
        padding-right: 20px; /* زيادة الحافة اليمنى */
    }
