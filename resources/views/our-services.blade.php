        ...
        <!--<div class="viergein viergein-active-2 mt-1">-->
            ...
            <div class="all-edara calman e">
                @foreach($services as $service)
                    <div class="item-servicse ss-or-sv rounded-0 border-3" style=" position: relative;
    right: 0%;
    top: 100px;  background: #fff; box-shadow: 0 4px 6px rgba(161, 73, 249, 0.1);">
                        <div class="img-servicse">
                            <span style="background: url({{ $service->image_url }})"></span>
                        </div>
                        <div class="px-4">
                            <h3 class="fs-4 fw-bold" style="color: rgb(63, 75, 187);">
                                {{ $service->title }}
                            </h3>
