...
<div class="all-secshen mt-6">
    ...
    <div class="container">
        <div class="row">
            @foreach($newgovernances as $newgovernance)
            <article class="card">
                <div class="card-img">
                ...
                <div class="project-info">
                    <div class="project-title">{{ $newgovernance->title }}</div>

                    <div class="gap-buttons" style="display: flex; flex-direction: column; gap:20px;">
                        <a href="#" class="secondary-cta preview-btn" data-id="{{ $newgovernance->id }}"
                            data-title="{{ $newgovernance->title }}"
                        ...
                        <a href="{{ route('newgovernance.download', $newgovernance->id) }}" class="secondary-cta"
                            style="display: flex; flex-direction: row; gap:15px;">
                            <div class="icon-circle">
...
document.querySelectorAll('.preview-btn').forEach(button => {
    button.addEventListener('click', function(event) {
        ...
        const pdfUrl = `/newgovernance/preview/${id}`;
