        ...
        <div class="row">
            ...
            <article class="card">
                ...
                <div class="project-info">
                    <div class="project-title">{{ $report->title }}</div>

                    <div class="gap-buttons" style="display: flex; flex-direction: column; gap:20px;">
                        <a href="#" class="secondary-cta preview-btn" data-id="{{ $report->id }}"
                            data-title="{{ $report->title }}" style="display: flex; flex-direction: row; gap:15px;    ">
                        ...
                        <a href="{{ route('activity-reports.show', $report->id) }}" class="secondary-cta"
...
document.querySelectorAll('.preview-btn').forEach(button => {
    button.addEventListener('click', function(event) {
        ...
        const pdfUrl = `/activity-reports/preview/${reportId}`;
