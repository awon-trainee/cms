                ...
                <div class="topnav"><!--اضافة ناف بار -->
                    ...
                    <a class="navbar-brand" href="#" style="top: 40%; ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16" style="color: aqua;  padding: 10px;">
                          ...
                          </svg>فريق عمل الجمعية
                   </a>
                </div>
            <div class="charity-teams" style=" margin-top: 15%;  ">
                @foreach($members as $member)
                    <div class="card position-relative shadow border border-none">
                        <div class="avatar position-absolute">
                            <img src="{{ $member->picture_url }}" class="card-img-top shadow rounded-circle" alt="{{ $member->name }}" />
                        </div>
                        <div class="card-body">
                            <p class="card-text" style=" color: rgba(53, 66, 184, 1);">{{ $member->name }}</p>
                            ...
                            <div class="d-flex align-items-center mt-3 gap-2">
                                ...
                                onclick="showMemberModal({{ json_encode($member) }}, {{ json_encode($member->picture_url) }}, {{ json_encode($teamQualification) }}, {{ json_encode($teamExperience) }})">
