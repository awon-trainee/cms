...
@section('content')
    <div class="all-secshen mt-6">
       <!-- <div class="viergein viergein-active-2 mt-1">-->
            ...
            <div class="charity-teams" style=" position: relative;
            right: 0%;
            top: 100px;">
                    ...
                    <div class="card position-relative shadow border border-none" >
                        ...
                        <div class="card-body" >
                            ...
                            <div class="d-flex align-items-center mt-3 gap-2">
                                ...
                                onclick="showMemberModal({{ json_encode($member) }}, {{ json_encode($member->picture_url) }}, {{ json_encode($assemblyQualification) }}, {{ json_encode($assemblyExperience) }})">
