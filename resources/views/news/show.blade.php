        ...
        <div class="viergein viergein-active-2 mt-1">
            <div class="all ">
                <div class="title text-center">
                    <h4 class="text-dark w-100">الأخبار</h4>
                </div><!--title-->
            </div>
            <div class="all-edara calman one two">
                <div class="title">
                    <div class="data">
                        ...
                        </svg> {{ $news->created_at->locale('ar')->translatedFormat('d M Y') }}م
                    </div>
                    <h5>{{ $news->title }}</h5>
                        <p class="card-text m-0">{{ $news->content }}</p>
                </div>
                <div class="img-servicse">
                    <div class="d-block" id="gallery">
                        <a href="{{ $news->mainImage?->image_url }}">
                            <img src="{{ $news->mainImage?->image_url }}" alt="" class="img-fluid rounded-4 mb-2">
                        </a>
                    </div>
                    ...
                    <div class="col-12" id="gallery">
                        <button class="btn btn-primary my-2 button-2   wow animate__fadeInLeft" data-wow-iteration="1" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-iteration-count: 1; animation-name: fadeInLeft;">
                            <a href="{{ route('news.index') }}" class="nav-link text-light">العودة للأخبار</a>
                        </button>
                    </div>
                </div>
            </div>
